...
// Middleware
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:3001','https://hrcc-recruitments.vercel.app/','http://hrcc-recruitments.vercel.app','https://hrcc-recruitments.vercel.app'],
  credentials: true
}));
