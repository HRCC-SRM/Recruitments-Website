...
import { creativesApplications } from "@/lib/sample-applications"
import { creativesResponses } from "@/lib/sample-responses"
    ...
    <div className="min-h-screen bg-background">
      <div className="border-b border-border">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold">Creatives: {app.name}</h1>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
        {creativesFormConfig.steps.map((step) => (
